...
import org.nanoframework.toolkit.message.support.ObjectMessage;
import org.nanoframework.toolkit.message.support.SimpleMessage;
...
public abstract class AbstractMessageFactory implements MessageFactory, Serializable {
    private static final long serialVersionUID = -2991152573418812152L;
