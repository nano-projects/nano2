...
public interface Result {
    ...
    final boolean JDBC_JSTL_CASE_INSENSITIVE_ORDER = Boolean
            .parseBoolean(System.getProperty(JDBC_JSTL_CASE_INSENSITIVE_ORDER_PROPERTY, "false"));

    /**
     * <p>
     * Returns the result of the query as an array of <code>SortedMap</code> objects. Each item of the array represents
     * a specific row in the query result.
     * </p>
     * <p>
     * A row is structured as a <code>SortedMap</code> object where the key is the column name, and where the value is
     * the value associated with the column identified by the key. The column value is an Object of the Java type
     * corresponding to the mapping between column types and Java types defined by the JDBC specification when the
     * <code>ResultSet.getObject()</code> method is used.
     * </p>
     * <p>
     * The <code>SortedMap</code> must use the <code>Comparator</code>
     * <code>java.util.String.CASE_INSENSITIVE_ORDER</code>. This makes it possible to access the key as a case
     * insensitive representation of a column name. This method will therefore work regardless of the case of the column
